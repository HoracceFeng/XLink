...
if __name__ == "__main__":
    ...
    ### CTW
    root_dir = util.io.get_absolute_path('/data/CTW/data')
    output_dir = util.io.get_absolute_path('/data/CTW/data/TFRecords/')
    _sets = 'train'
    ...
    cvt_to_tfrecords(output_path = util.io.join_path(output_dir, 'CTW_train.tfrecord'), data_path = training_data_dir, gt_path = training_gt_dir)
