    ...
    with tf.python_io.TFRecordWriter(output_path) as tfrecord_writer:
        for idx, image_name in enumerate(image_names):
            ...
            for obj in jsondict['shapes']:
                ...
                print "    >>>>> ", num_pts, len(gt), '\t', xmin, ymin, xmax, ymax
...
if __name__ == "__main__":
    ...
    ### RCTW
    root_dir = util.io.get_absolute_path('/data/RCTW17/data')
    output_dir = util.io.get_absolute_path('/data/RCTW17/data/TFRecords/')
    _sets = 'train'
    ...
    cvt_to_tfrecords(output_path = util.io.join_path(output_dir, 'RCTW17_train.tfrecord'), data_path = training_data_dir, gt_path = training_gt_dir)
